...
namespace CVAPI.Manager
{
    public class CVItemManager
    {
        ...
        public CVItemManager()
        {
            ...
            CVItem testItem1 = new CVItem(1, "Underdirektør", "Valdemarsplads 1", "Something", DateTime.Today.AddMonths(-10), DateTime.Today, categories[0]);
            CVItem testItem2 = new CVItem(2, "Datamatiker", "Erhvervsakademi Sjælland, Roskilde", "En beskrivelse af hvad man har lært under uddannelsesforløbet", DateTime.Today.AddMonths(-10), DateTime.Today, categories[1]);
            Post(testItem1);
            Post(testItem2);
        }
